...
public class ErrorMessage {
    ...
    public static void printDeadlineSyntaxCommandMessage(String command) {
        System.out.println("-----------------------------------------");
        System.out.println("!bot: invalid duke.command: " + command);
    ...
    public static void printCommandTypeErrorMessage() {
        System.out.println("-----------------------------------------");
        System.out.println("!bot: invalid duke.command type");
    ...
    public static void printNullCommandErrorMessage() {
        System.out.println("-----------------------------------------");
        System.out.println("!bot: duke.command.Command cannot be empty! Please try another duke.command!");
        System.out.println("-----------------------------------------");
    }

    public static void printOutOfBoundsErrorMessage() {
        System.out.println("-----------------------------------------");
        System.out.println("duke.task.Task number is not valid");
        System.out.println("-----------------------------------------");
    }

    public static void printNumberFormatErrorMessage() {
        System.out.println("-----------------------------------------");
        System.out.println("!bot: duke.task number should be an integer");
        System.out.println("-----------------------------------------");
    }
}
